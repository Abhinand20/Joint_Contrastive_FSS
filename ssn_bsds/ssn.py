...
class conv_bn_relu(nn.Module):
    def __init__(self, in_channels, channels, bn=True):
        ...
        # For final feature dimension reduction
...
class resnet_extractor(nn.Module):
    """
    1) Initialize the resnet50 module
    2) Forward pass - get the features, upsample, reduce channels and return
    """
    def __init__(self,in_channels, out_channels, num_pixel_features):
        ...
        # # TEST: Setting to eval for simplicity
        # self.RNET.eval()
        ...
        self.conv7 = conv_bn_relu(3 * out_channels + in_channels, num_pixel_features - in_channels, False)
        self.activation = {}
...
class SSN(nn.Module):
    def __init__(self, in_channels, out_channels, C, K_max, iter_EM, color_scale, p_scale, H, W, num_classes):
        ...
        self.CNN = resnet_extractor(in_channels, out_channels, self.C)
    ...
    def forward(self, Lab, labels = None):
        ...
        # print(1, XYLab.shape) 2, 5, 201, 201
        features = self.CNN(XYLab)
        #print(2, features.shape) [2, 20, 201, 201]
